<div class="col-12 col-sm-6 col-md-5 mb-5">
    ...
    <div class="mt-1 px-3 px-md-0 h4 text-color">{{ format_rupiah($product->price) }}</div>
    <div class="mt-4 px-3 px-md-0 text-l text-neutral-80 more" style="word-break: break-all; ">
        {{ $product->description }}
    </div>
